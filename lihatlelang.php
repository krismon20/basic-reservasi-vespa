<html>
    ...
    <body align="center">
        ...
        <form name="fpenjualan" action="updatelelang.php" method="post">
            ...
            <hr>
            <?php
                echo "<a href='editlelang.php?namalengkap=$namalengkap'>Edit</a>"
            ?>
            <?php
                echo "<a href='tawarlelang.php'>Tambah Baru</a>";
            ?>
            <?php
                echo "<a href='tabel_tawar_vespa.php'>Kembali</a>";
            ?>
